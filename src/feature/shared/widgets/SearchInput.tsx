// src/feature/shared/widgets/SearchInput.tsx
  ...
  return (
    <div className='relative w-full max-w-md'>
      ...
      <input
        ...
        placeholder='Search...'
        className='w-full pl-11 pr-11  py-3 sm:py-4 rounded-full border border-neutral-300 focus:outline-none focus:ring-2 focus:ring-neutral-300 text-sm sm:text-base text-neutral-950'
      />
      {query && (
        <button
          onClick={handleClear}
