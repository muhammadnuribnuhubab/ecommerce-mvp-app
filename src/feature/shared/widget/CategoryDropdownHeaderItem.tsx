...
export const CategoryDropdownHeaderItem = ({
  ...
  return (
    <button
      onClick={onClick}
      className={clsx(
        'flex gap-2 w-full py-2 pb-2 bg-white rounded-lg transition-colors hover:underline text-primary-300 cursor-pointer  flex-col items-center justify-center',
        className
      )}
    >
